...
function takeCommand(message) {
    ...
    if (message.includes('how are you')) {
        ...
        response = "Hello! my name is sangita, Sabuj calls me Manu so you can also call me Manu.";
        ...
        response = "Sabuj's favorite song!";
    ...
    } else if (message.includes('please open gallery')) {
        response = 'Opening the gallery for you.';
        galleryContainer.classList.remove('hidden');
    } else if (message.includes('do you want to go on a date with me')) {
        response = 'Yes, my love, I have fixed our date in a 5-star hotel.';
        audioFile = 'Yes my love I have fixe 2.wav';
        window.open('https://www.dineout.co.in/kolkata/la-cucina-salt-lake-east-kolkata-4025');
    } else if (message.includes("break up with you.")) {
        response = "I want to break up with you.";
        audioFile = 'Y2meta.app - Crying Woman Manic Sound Effect (128 kbps).mp3';
    } else if (message.includes("play break up song.")) {
        response = "Playing breakup song!";
        audioFile = 'The Breakup Song Ae Dil Hai Mushkil 128 Kbps.mp3';
    } else {
